  ...
  return (
    <header className="fixed top-4 left-3 right-3 z-50">
      <div className="max-w-7xl mx-auto py-3 px-4 rounded-2xl bg-black/50 backdrop-blur-md flex items-center justify-between border border-neutral-700/80">
        ...
        <div className="md:flex hidden space-x-7.5 text-gray-500 text-sm">
        ...
        <div className="md:flex hidden space-x-4">
          <span className="text-gray-300 text-lg hover:bg-gray-800 p-2 rounded-lg">
            <LuMusic />
          </span>
          <span className="text-gray-300 text-lg hover:bg-gray-800 p-2 rounded-lg">
            <LuMoon />
...
<span className="block md:hidden text-gray-300 text-2xl hover:bg-gray-800 p-2 rounded-lg">
  <BiMenu />
</span>
