...
const Contact = () => {
  ...
  return (
    <section id="contact" className="pt-34 lg:pt-45 pb-15 lg:pb-30">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 xl:px-0">
        ...
        <div className="flex lg:flex-row flex-col items-center md:gap-y-8 gap-y-12 md:gap-x-8 gap-x-12 ">
          <div className="w-full px-4 py-6 border border-neutral-300/80 dark:border-neutral-700/80 rounded-2xl dark:bg-(--purple-950)/60 bg-(--purple-50)/60 backdrop-blur-md">
            ...
            >
              ...
              <button className="mt-6 px-4 py-3 md:px-6 md:py-3 text-sm md:text-base font-medium rounded-lg text-white bg-linear-to-r from-(--purple-800) dark:from-(--purple-700) to-(--purple-500) cursor-pointer">
                Submit
              </button>
              {error.submitError && (
